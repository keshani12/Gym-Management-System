...
function UpdateScheduleForm() {
    ...
    const fetchSchedule = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/TrainerSchedule/get/${id}`);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://localhost:3000/TrainerSchedule/update/${id}`, formData);
    ...
    return (
        <div style={styles.container}>
            <div style={styles.form}>
                <h2 style={{color:"white", fontSize:"25px"}}>Update Schedule</h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={styles.inputGroup}>
                        ...
                        <input
                            type="text"
                            name="Member_id"
                            value={formData ? formData.Member_id : ''}
                            onChange={handleChange}
                            style={styles.input}
                            required
                        />
                    ...
                    <div style={styles.inputGroup}>
                        ...
                        <input
                            type="time"
                            name="timeslot"
                            value={formData ? formData.timeslot : ''}
                            onChange={handleChange}
                            style={styles.input}
                            required
                        />
...
>
  ...
  <option value="Sarangi Nimesha">Sarangi Nimesha</option>
  <option value="Gamithu Thiwanka">Gamithu Thiwanka</option>
  <option value="Kavidu Konara">Kavidu Konara</option>
